...
class OmniSciEnSightFileFormat : public SdfFileFormat, public PcpDynamicFileFormatInterface
{
public:
...
protected:
    ...
    OmniSciEnSightFileFormat();
    ~OmniSciEnSightFileFormat() override;
};

// clang-format off
#define OMNI_SCI_EN_SIGHT_FILE_FORMAT_TOKENS                     \
    ((Id,               "OmniSciEnSightFileFormat"))        \
    ((Version,          "1.0"))                      \
    ((Target,           "usd"))                      \
    ((Extension,        "case"))                     \
    ((AliasExtension,   "encas"))                    \
...
TF_DECLARE_PUBLIC_TOKENS(OmniSciEnSightFileFormatTokens, OMNI_SCI_EN_SIGHT_FILE_FORMAT_TOKENS);
// clang-format on

TF_DECLARE_WEAK_AND_REF_PTRS(OmniSciEnSightFileFormat);

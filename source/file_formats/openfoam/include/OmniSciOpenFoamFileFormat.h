...
class OmniSciOpenFoamFileFormat : public SdfFileFormat, public PcpDynamicFileFormatInterface
{
public:
...
protected:
    ...
    OmniSciOpenFoamFileFormat();
    ~OmniSciOpenFoamFileFormat() override;
};

// clang-format off
#define OMNI_SCI_OPEN_FOAM_FILE_FORMAT_TOKENS            \
    ((Id,              "OmniSciOpenFoamFileFormat"))    \
    ((Version,         "1.0"))                       \
    ((Target,          "usd"))                       \
    ((Extension,       "foam"))                      \
...
TF_DECLARE_PUBLIC_TOKENS(OmniSciOpenFoamFileFormatTokens, OMNI_SCI_OPEN_FOAM_FILE_FORMAT_TOKENS);
// clang-format on

TF_DECLARE_WEAK_AND_REF_PTRS(OmniSciOpenFoamFileFormat);

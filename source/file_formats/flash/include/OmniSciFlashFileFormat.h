...
class OmniSciFlashFileFormat : public SdfFileFormat, public PcpDynamicFileFormatInterface
{
public:
...
protected:
    ...
    OmniSciFlashFileFormat();
    ~OmniSciFlashFileFormat() override;
};

// clang-format off
#define OMNI_SCI_FLASH_FILE_FORMAT_TOKENS              \
    ((Id,              "OmniSciFlashFileFormat"))     \
    ((Version,         "1.0"))                        \
    ((Target,          "usd"))                        \
    ((Extension,       "flash"))                      \
...
TF_DECLARE_PUBLIC_TOKENS(OmniSciFlashFileFormatTokens, OMNI_SCI_FLASH_FILE_FORMAT_TOKENS);
// clang-format on

TF_DECLARE_WEAK_AND_REF_PTRS(OmniSciFlashFileFormat);

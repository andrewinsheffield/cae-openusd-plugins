...
class OmniSciVtkHdfFileFormat : public SdfFileFormat, public PcpDynamicFileFormatInterface
{
public:
...
protected:
    ...
    OmniSciVtkHdfFileFormat();
    ~OmniSciVtkHdfFileFormat() override;
};

// clang-format off
#define OMNI_SCI_VTKHDF_FILE_FORMAT_TOKENS               \
    ((Id,              "OmniSciVtkHdfFileFormat"))       \
    ((Version,         "1.0"))                           \
    ((Target,          "usd"))                           \
    ((Extension,       "vtkhdf"))                        \
...
TF_DECLARE_PUBLIC_TOKENS(OmniSciVtkHdfFileFormatTokens, OMNI_SCI_VTKHDF_FILE_FORMAT_TOKENS);
// clang-format on

TF_DECLARE_WEAK_AND_REF_PTRS(OmniSciVtkHdfFileFormat);

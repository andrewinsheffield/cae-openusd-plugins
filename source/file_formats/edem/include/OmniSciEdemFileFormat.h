...
class OmniSciEdemFileFormat : public SdfFileFormat, public PcpDynamicFileFormatInterface
{
public:
...
protected:
    ...
    OmniSciEdemFileFormat();
    ~OmniSciEdemFileFormat() override;
};

// clang-format off
#define OMNI_SCI_EDEM_FILE_FORMAT_TOKENS                \
    ((Id,              "OmniSciEdemFileFormat"))       \
    ((Version,         "1.0"))                      \
    ((Target,          "usd"))                      \
    ((Extension,       "dem"))                      \
...
TF_DECLARE_PUBLIC_TOKENS(OmniSciEdemFileFormatTokens, OMNI_SCI_EDEM_FILE_FORMAT_TOKENS);
// clang-format on

TF_DECLARE_WEAK_AND_REF_PTRS(OmniSciEdemFileFormat);
